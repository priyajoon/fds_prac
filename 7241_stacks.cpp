...
int main()
{
    ...
    cout << "infix expression of the above postfix expression is : "<<Pst_to_In(exp)<<endl;
    cout << "prefix expression of the above postfix expression is : "<<Pst_to_Pre(exp)<<endl;
